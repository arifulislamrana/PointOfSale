          ...
          <CRow>
            ...
            <CCol>
              <div class="text-right">
                <CButton color="primary" @click="$router.push({name: 'AddBranch'})">Add Branch</CButton>
              </div>
            </CCol>
          </CRow>
        </CCardHeader>
        <CCardBody>
          ...
          >
            <template #id="data">
              <td>
                <CButtonGroup>
                  <CButton color="info" @click="$router.push({name: 'EditBranch', params: { id: data.item.id } })">
                    Edit
                  </CButton>
...
export default {
  ...
  methods: {
    ...
    deleteItem() {
      var self = this;
      api
          .delete('business/branch/' + this.selectedDeleteItemId, {
