            ...
            <CCard class="mb-0">
              ...
              <CCollapse :show="accordion === 0">
                <CCardBody>
                  ...
                  cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon
            ...
            <CCard class="mb-0">
              ...
              <CCollapse :show="accordion === 2">
                <CCardBody>
                  ...
                  beer labore wes anderson cred
                  nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft
                  beer farm-to-table, raw denim aesthetic synth nesciunt you probably havent heard of them accusamus
                  labore sustainable VHS.
                </CCardBody>
              </CCollapse>
            </CCard>
